...
#define GS_CONTROL_TELECOMMUNICATION_UART_BUFFER_SIZE 512

#define GS_CONTROL_DELAY_BETWEEN_STATUS_PACKETS_MS 50
#define GS_CONTROL_DELAY_BETWEEN_COMMANDS_MS 127
#define GS_CONTROL_DELAY_BETWEEN_COMMANDS_FAST_MS 50

#define GS_CONTROL_BOARD_COMMAND_DURATION_MS 200
